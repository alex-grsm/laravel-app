...
const filterSubmit = () => filterForm
  .transform((data) =>
    Object.fromEntries(
      Object.entries(data)
        .filter(([_, value]) => value !== 0 && value) // Фильтрация пустых или нулевых значений
    )
  )
  .get(route('listing.index'), { preserveState: true, preserveScroll: true });
